const root = document.getElementById("powerup");
const rt = new Retro();
...
const mushroom = board.addSprite("assets/mushroom.png", "Mushroom", 500, 400);
...
const mushroomPowerup = function (intruderID) {
    ...
    setTimeout(() => (board.player.speed = oldSpeed), 10000);
};
